...
class TextImageGenerator(keras.callbacks.Callback):
    ...
    def build_word_list(self, num_words, max_string_len=None, mono_fraction=0.5):
        ...
        tmp_string_list,self.flags = wg.newDataset(num_words)
    ...
    def get_batch(self, index, size, train):
        ...
        outputs = {'ctc': np.zeros([size]),'dense':np.zeros([size])}  # dummy data for dummy loss function
    ...
    def on_train_begin(self, logs={}):
        ...
        self.paint_func = lambda text: hp.paint_text(text, self.img_w, self.img_h,
